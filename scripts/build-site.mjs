...
░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░      ░▒▓█▓▒░  ░▒▓█▓▒░
 ░▒▓██████▓▒░░▒▓█▓▒░░▒▓█▓▒░▒▓███████▓▒░   ░▒▓█▓▒░</pre></div>
	...
	<section class="motivation">
		...
		<ul>
			<li>Assigning an LLM an expert role measurably changes the <em>shape</em> of its output — deeper domain framing at the cost of some plain-language clarity, a real trade-off rather than a free upgrade. <a href="https://arxiv.org/abs/2605.29420" target="_blank" rel="noopener">Malik &amp; Chinnappa, 2024 ↗</a></li>
			<li>For tool-using agents specifically, persona/role structure acts as a <strong>decision filter on tool calls</strong> — not just tone, but whether and when the agent reaches for a tool at all, catching the "under-acting" failure mode where agents skip tools their role should obviously use. <a href="https://arxiv.org/abs/2509.00482" target="_blank" rel="noopener">Xu et al., 2024 ↗</a></li>
