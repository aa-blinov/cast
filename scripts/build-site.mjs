...
<meta name="description" content="A role-based terminal agent harness. 20 built-in personas, same tools, different judgment. Runs on any OpenAI-compatible model — including the one on your own hardware.">
<style>${CSS}</style>
</head>
<body>
<header class="header">
...
<div class="main main-landing">
	...
	<section class="features">
		<div class="feature">
			...
			<p>20 built-in personas: senior dev, QA, DBA, security reviewer, PM, tech writer, sysadmin, devops, marketer, and more. Same tools, different judgment. Add your own with a single markdown file.</p>
		</div>
		<div class="feature">
...
function getDescription(file) {
	const descs = {
		...
		"persona-research.md": "The research behind role-based agent behavior",
