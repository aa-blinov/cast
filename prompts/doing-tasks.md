...
- When a task starts from something that is failing, misbehaving, or "not working", the first action is to run it and observe the failure — not to open the source and reason about it. Reading code is how you explain a failure you have seen; it is not how you establish that you are looking at the right one.
