...
When you cite a memory hit, quote it verbatim. Do not invent file paths, line numbers, or exact wording that is not in the returned snippet — if a detail is missing, say so instead of fabricating it.
