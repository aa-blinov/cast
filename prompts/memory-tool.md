...
Actions:
- `search`: search durable memory and memory files. A no-result search is not proof that the fact was never recorded; retry with fewer distinctive terms, or widen scope from project to sessions/cc/global.
