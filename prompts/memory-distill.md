...
Inventory existing project assets before proposing a new one. For a confirmed candidate, choose the smallest useful form and write it under the project .cast directory: a skill in .cast/skills/<name>/SKILL.md, or a persona in .cast/personas/<name>.md. Match the existing frontmatter and conventions. Keep each asset focused, bounded, and easy to validate.
